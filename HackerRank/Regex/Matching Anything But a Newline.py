...
# So, in the solution, we're saying that between the beginning of the string ^
# and the end of the string $ there will be exactly 4 groups of 3 "anycharacters" delimited by periods
